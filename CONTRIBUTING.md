...
You want to contribute to TheirStory Portals? Welcome! Please read this document to understand what you can do:
...
You can help TheirStory Portals by helping others who use it and need support.

## Analyze Issues

Analyzing issue reports can be a lot of effort. Any help is welcome!
Go to [the GitHub issue tracker](https://github.com/theirstory/ts-portal/issues?state=open) and find an open issue which needs additional work or a bugfix (e.g. issues labeled with "help wanted" or "bug").
...
If you find a bug - behavior of TheirStory Portals code contradicting your expectation - you are welcome to report it.
We can only handle well-reported, actual bugs, so please follow the guidelines below.

Once you have familiarized with the guidelines, you can go to [the GitHub issue tracker](https://github.com/theirstory/ts-portal/issues/new/choose) to report the issue.
...
Please use [GitHub Security Advisories](https://github.com/theirstory/ts-portal/security/advisories/new) for private reporting.
...
We want to improve the quality of TheirStory Portals and good bug reports are welcome! But our capacity is limited, thus we reserve the right to close or to not process insufficient bug reports in favor of those which are very cleanly documented and easy to reproduce. Even though we would like to solve each well-documented issue, there is always the chance that it will not happen - remember: TheirStory Portals is Open Source and comes without warranty.

Bug report analysis support is very welcome! (e.g. pre-analysis or proposing solutions)

## Contribute Code

You are welcome to contribute code to TheirStory Portals in order to fix bugs or to implement new features.
...
3.  **Not all proposed contributions can be accepted**. Some features may e.g. just fit a third-party add-on better. The code must fit the overall direction of TheirStory Portals and really improve it. The more effort you invest, the better you should clarify in advance whether the contribution fits: the best way would be to just open an issue to discuss the feature you plan to implement (make it clear you intend to contribute).

### Contributor License Agreement

When you contribute (code, documentation, or anything else), you have to be aware that your contribution is covered by the same [Apache 2.0 License](https://www.apache.org/licenses/LICENSE-2.0) that is applied to TheirStory Portals itself.

In particular you need to agree to the Contributor License Agreement (CLA) for this repository.
TheirStory Portals uses the hosted CLA Assistant service at [cla-assistant.io](https://cla-assistant.io/) and will ask you to confirm that in your pull request.

This applies to all contributors, including those contributing on behalf of a company.
If you agree to its content, you simply have to click on the link posted by the TheirStory Portals as a comment to the pull request. Click it to check the CLA, then accept it on the following screen if you agree to it.
TheirStory Portals will save this decision for upcoming contributions and will notify you if there is any change to the CLA in the meantime.
...
2.  Create a branch forking TheirStory Portals repository and do your change
...
8.  Wait for our code review and approval, possibly enhancing your change on request
    - Note that the TheirStory Portals developers also have their regular duties, so depending on the required effort for reviewing, testing and clarification this may take a while
